...
Training and inference wrapper for ARANet-B.
Handles loss computation, optimizer step, scheduler, and checkpoint
saving/loading within the standard training loop.
"""
...
class ModelARANetB(ModelBase):
    """Train with pixel loss"""
    def __init__(self, opt):
        super(ModelARANetB, self).__init__(opt)
        # ------------------------------------
        # define network
        # ------------------------------------
